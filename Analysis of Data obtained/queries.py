...
try:
   ...
   Users_joined = "select count(*) from speechtotextbackend_user where created >='2019-08-30' and created < CURRENT_TIMESTAMP"
   audiolen_hindi = "select sum(\"audio_length\") from speechtotextbackend_textfileappuser where \"conversionDateTime\">='2019-08-30'  and \"conversionDateTime\"< CURRENT_TIMESTAMP and \"audioFile\" like 'text_audio_files/Hindi/%'"
   audiolen_marathi = "select sum(\"audio_length\") from speechtotextbackend_textfileappuser where \"conversionDateTime\">='2019-08-30'  and \"conversionDateTime\"< CURRENT_TIMESTAMP and \"audioFile\" like 'text_audio_files/Marathi/%'"
   audiolen_tamil = "select sum(\"audio_length\") from speechtotextbackend_textfileappuser where \"conversionDateTime\">='2019-08-30'  and \"conversionDateTime\"< CURRENT_TIMESTAMP and \"audioFile\" like 'text_audio_files/Tamil/%'"
   audiolen_telugu = "select sum(\"audio_length\") from speechtotextbackend_textfileappuser where \"conversionDateTime\">='2019-08-30'  and \"conversionDateTime\"< CURRENT_TIMESTAMP and \"audioFile\" like 'text_audio_files/Telugu/%'"
   audiolen_total =  "select sum(\"audio_length\") from speechtotextbackend_textfileappuser where \"conversionDateTime\">='2019-08-30'  and \"conversionDateTime\"< CURRENT_TIMESTAMP "
   ...
   tasks_per_language = "select count(*),language from speechtotextbackend_textfileappuser,speechtotextbackend_textfile where speechtotextbackend_textfile.id = speechtotextbackend_textfileappuser.\"textFile_id\" and speechtotextbackend_textfileappuser.\"conversionStatus\"=2 and speechtotextbackend_textfileappuser.\"conversionDateTime\">='2019-08-30'  and speechtotextbackend_textfileappuser.\"conversionDateTime\"< CURRENT_TIMESTAMP group by speechtotextbackend_textfile.language "
