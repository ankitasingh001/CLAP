...
Marathi_SoundFile_Verification_data_sample.csv :
...
Contains user data linked to Marathi_SoundFile_Verification_data_sample.csv via user-id :
...
Contains audio files of the tasks contributed with the same nomenclature as defined in Marathi_SoundFile_Verification_data_sample.csv
